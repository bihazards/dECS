...
public class ComponentBundle<T1,T2,T3,T4,T5>
{
	...
	private ComponentBundle(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5)
	{
		this.t1 = t1;
		this.t2 = t2;
		this.t3 = t3;
	...
	{
		return new ComponentBundle<T1,T2,T3,T4,T5>(t1,t2,t3,t4,t5);
	}

	public static <T1, T2, T3, T4> ComponentBundle<T1,T2,T3,T4,Class<Void>> bundleOf(T1 t1, T2 t2, T3 t3, T4 t4)
	{
		return new ComponentBundle<T1,T2,T3,T4,Class<Void>>(t1,t2,t3,t4,Void.class);
	}

	public static <T1, T2, T3> ComponentBundle<T1,T2,T3,Class<Void>,Class<Void>> bundleOf(T1 t1, T2 t2, T3 t3)
	{
		return new ComponentBundle<T1,T2,T3,Class<Void>,Class<Void>>(t1,t2,t3,Void.class,Void.class);
	}

	public static <T1, T2> ComponentBundle<T1,T2,Class<Void>,Class<Void>,Class<Void>> bundleOf(T1 t1, T2 t2)
	{
		return new ComponentBundle<T1,T2,Class<Void>,Class<Void>,Class<Void>>(t1,t2,Void.class,Void.class,Void.class);
	}

	public static <T1> ComponentBundle<T1,Class<Void>,Class<Void>,Class<Void>,Class<Void>> bundleOf(T1 t1)
	{
		return new ComponentBundle<T1,Class<Void>,Class<Void>,Class<Void>,Class<Void>>(t1,Void.class,Void.class,Void.class,Void.class);
	}
